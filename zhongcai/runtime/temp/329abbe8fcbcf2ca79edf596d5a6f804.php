<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/home/fastadmin/www/public/../application/common/view/tpl/dispatch_jump.tpl";i:1523974192;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="system-message <?php echo $codeText; ?>">
            <div class="image">
                <img src="/zhongcai/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo $msg; ?></h1>
            <p class="jump">
        ...
        <div class="copyright">
            <p>Powered by <a href="https://www.wszx.cc">文始征信</a></p>
        </div>
