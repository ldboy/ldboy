<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"/home/fastadmin/www/public/../application/admin/view/index/index20180512zhz.html";i:1523974192;s:59:"/home/fastadmin/www/application/admin/view/common/meta.html";i:1523974192;s:61:"/home/fastadmin/www/application/admin/view/common/header.html";i:1523974192;s:59:"/home/fastadmin/www/application/admin/view/common/menu.html";i:1523974192;s:62:"/home/fastadmin/www/application/admin/view/common/control.html";i:1523974192;s:61:"/home/fastadmin/www/application/admin/view/common/script.html";i:1523974192;}*/ ?>
<!DOCTYPE html>
...
<link rel="shortcut icon" href="/zhongcai/assets/img/favicon.ico" />
<!-- Loading Bootstrap -->
<link href="/zhongcai/assets/css/backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">

<!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
<!--[if lt IE 9]>
  <script src="/zhongcai/assets/js/html5shiv.js"></script>
  <script src="/zhongcai/assets/js/respond.min.js"></script>
<![endif]-->
...
<nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <li>
                <a href="/zhongcai/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
            </li>
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="/zhongcai<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                    <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                </a>
                <ul class="dropdown-menu">
                    <!-- User image -->
                    <li class="user-header">
                        <img src="/zhongcai<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/zhongcai<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
...
<!-- /.control-sidebar -->
        ...
        <!-- ./wrapper -->
        <!-- end main content -->
        <script src="/zhongcai/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/zhongcai/assets/js/require-backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script>
    </body>
</html>