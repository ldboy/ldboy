...
class Backend extends Controller
{
    ...
    public function use_form_Js()
    {
        ...
        $this->assignconfig("actionname","run");
        $this->use_action_js("form", "wsform", "wscommon");
    ...
    public function _initialize()
    {
        ...
        if (!$this->auth->match($this->noNeedLogin))
        {
            ...
            if (!$this->auth->isLogin())
            {
                ...
                $this->error(__('Please login first'), 'http://zc.wszx.cc/zc_login-index.html?url='. urlencode($url));
            }
            // 判断是否需要验证权限
        ...
        $admin['nickname'] = LoginUser::getRoleRoleName();
