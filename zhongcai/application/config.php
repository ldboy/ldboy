...
$config = [
    ...
    'session'                => [
        ...
        'type'           => 'Db',//think\session\driver\Db
        // 是否自动开启 SESSION
        'auto_start'     => true,
...
//if ( IS_CLI  ||    $_SERVER['REMOTE_HOST']=="124.239.196.194")
//{
    $config['session']=
        [
            ...
            'id'             => '',
            // SESSION_ID的提交变量,解决flash上传跨域
            'var_session_id' => '_s_code_',
            // SESSION 前缀
            'prefix'         => 'think',
            // 驱动方式 支持redis memcache memcached
            'type'           => 'Redis',//think\session\driver\Db
            // 是否自动开启 SESSION
            'auto_start'     => true,

            'host'         => 'cache.redis.cache.chinacloudapi.cn', // redis主机
            'port'         => 6379, // redis端口
            'password'     => 'q7ijHaepbo0c/NVh3w6cgmgeRPT9SBL+//esjI2jNm8=', // 密码
            'expire'=>3600*10
...
//\think\Route::domain('blog','blog?var=thinkphp');
return $config;
