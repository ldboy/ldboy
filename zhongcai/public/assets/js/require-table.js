    ...
    var Table = {
        ...
        api: {
            ...
            formatter: {
                ...
                textcolor: function (value, row, index) {


                    return '<span style="color:'+row[this.field+"_color"]+'">' + __(value) + '</span>';
                },
                bgcolor: function (value, row, index) {

                    return '<span  style="display: block ;background-color:'+row[this.field+"_color"]+'">' + __(value) + '</span>';
                },
                bgcolorClass: function (value, row, index) {

                    return '<span  style="display: block" class="'+row[this.field+"_color"]+'">' + __(value) + '</span>';
                },
