...
define("slimscroll", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$.fn.extend;
    };
...
define("adminlte", ["bootstrap","slimscroll"], (function (global) {
    return function () {
        var ret, fn;
 ...
 */
define('backend/dossier/info',['jquery', 'bootstrap', 'backend', 'table', 'form','adminlte'], function ($, undefined, Backend, Table, Form,AdminLTE) {
...
define('backend/dossier/dlisttabs',['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
                ...
                columns: [
                    [
                        ...
                        {field: 'operate', title: __('Operate'), formatter: function () {
                            console.log($.fn.bootstrapTable.defaults);
                            //console.log($.fn.bootstrapTable.defaults.extend.view_url+arguments[1]['id']);
