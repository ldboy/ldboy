    ...
    var Fast = {
        ...
        api: {
            ...
            open: function (url, title, options) {
                ...
                var area = [$(window).width() > 800 ? '95%' : '95%', $(window).height() > 600 ? '95%' : '95%'];
                ...
                options = $.extend({
                    ...
                    cancel: function (index, layero) {
                        ...
                        Layer.close(index);
                        if (Layer.wsreload) { //只有当点击confirm框的确定时，该层才会关闭
            ...
            closeAndReload:function(index,ceng)
            {
                Layer.close(index);
                if(ceng>1)
                {
                    ...
                    {
                        cmd = cmd+"parent.";
                        eval(cmd+"Layer.wsreload=1;")
                    }
                }
                window.location.reload();
            },
            reload:function(ceng)
            {
                var thisreload = false;
                 if(ceng>0  )  thisreload = true;
                if(ceng>1)
                {
                    ceng = ceng-1;
                    var cmd = "";
                ...
                if (thisreload) window.location.reload();
